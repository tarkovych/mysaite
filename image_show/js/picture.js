...
<div>
	<div class="" id="divIMG">
		<img src="img/img/${
      ObjRow[0]["IMG"]
    }" class="img-thumbnail img-fluid mx-auto d-block" id="imageTran" alt="..." style="" >
	</div>
</div>
...
function TABLE1(arr) {
  let hTable = [
    "<span class='ru'>Название категории</span><span class='ua'>Назва категорії</span><span class='en'>Name of category</span>",
    "<span class='ru'>Имя вопроса</span><span class='ua'>Ім'я питання</span><span class='en'>Question name</span>",
    "<span class='ru'>Категория</span><span class='ua'>Категорія</span><span class='en'>Category</span>",
    "<span class='ru'>Значение категории</span><span class='ua'>Значення категорії</span><span class='en'>Category value</span>"
  ];
...
function TABLE2(arr) {
  let hTable = [
    "<span class='ru'>Прием пищи</span><span class='ua'>Споживання</span><span class='en'>Meal</span>",
...
function TABLE3(arr) {
  let hTable = [
    "<span class='ru'>Питательный</span><span class='ua'>Поживний</span><span class='en'>Nutritional</span>",
...
function TABLE4(arr) {
  let hTable = [
    "<span class='ru'>Пол</span><span class='ua'>Стать</span><span class='en'>Gender</span>",
