    ...
    <div class="row">
        <div class="col-xl-4 col-lg-6">
            ...
            <form action="" id="FormGoogle" method="post">
                    ...
                    <div class="col-8 ">
                        ...
                        <div class="btn-group">
                            ...
                            <input type="text" class="form-control w-100 dropdown-toggle" autocomplete="off" id="WORD"
                             name="WORD" data-toggle="dropdown" 
                ...
                <div class="row">
                    <div class="col">
                        <input type="button" class="btn btn-outline-primary " onclick="RESULT2()" id="searchBtn" value="SHOW" style="width:200px">
                    </div>
                    <div class="col">
                        <input type="submit" class="btn btn-outline-primary " onclick="" id="resetBtn" value="RESET" style="width:200px">
                    </div>
                </div>
            </form>
            <!-- ////////////////////new -->
            ...
            <form action="" id="FormAction" method="post">
                ...
                <div class="row">
                    <div class="col ">
                        <input type="button" class="btn btn-outline-primary " onclick="RESULT(0)" id="searchBtn" value="SHOW" style="width:200px">
                    </div>
                    <div class="col ">
                        <input type="submit" class="btn btn-outline-primary " onclick="" id="resetBtn" value="RESET" style="width:200px">
                    </div>
