        ...
        <div class="row  w-100">
            ...
            <div class="col-8">
                <form class="form-inline " id="FORMOFF">
                    <div class="row w-100">
                        <div class="col-8">
                            <input id="GOOGLEVALUE" oninput="ZAPROZAJAX(this.value)"
                                class="form-control mr-sm-2  dropdown-toggle w-100" type="search" placeholder="Search"
                                aria-label="Search" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <div class="dropdown-menu" id="DROPGOOLE"></div>
                        </div>
                        <div class="col-4">
                            <input type="button" class="btn btn-outline-dark my-2 my-sm-0 "
                                style="border:solid black 2px ; font-weight:bold" value="Search" autocomplete="off"
