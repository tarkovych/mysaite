...
<body>
	<script>
		...
		document.getElementById("ver").innerHTML= "<br><b><span style='font-size:24px;' >"+ link_name +"</span></b> <br>Version: "+version;
	...
	<div>
		...
		<br>
		<br>
		<label for="project_name">Введите номер версии:</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		<input type="numeric" id="version" name="project_name" required="" />
		<br>
		<br>
	</div>
	<div>
